...
if __name__ == "__main__":
    ...
    # # plt.show()
    # # augmentation_magnitude = abs(augmentation_magnitude)
    # from curve_plotting import plot_severity_vs_confidence
    # ssim, ncc, uiq, scc = plot_severity_vs_confidence(augmentation_type)
    # plt.figure(figsize=(10, 6))
    # plt.plot(rotation_values_lim[31:], confidence_values_lim[31:], '-', label=f'Contrast HVS', color='red', linewidth=2)
    # plt.plot(augmentation_magnitude[31:], model_accuracy[31:], "-", label="Model Confidence", color="blue", linewidth=2)
    # plt.plot(augmentation_magnitude[31:], estimated_confidence_values1[31:], '-.', label=f'k={k1}', color='purple', linewidth=2)
    # plt.plot(augmentation_magnitude[31:], estimated_confidence_values2_m[31:], '--', label=f'k={k2}', color='purple', linewidth=2)
    # plt.plot(augmentation_magnitude[31:], ssim[31:], '-', label='SSIM', color='darkred', linewidth=1)
    # plt.plot(augmentation_magnitude[31:], ncc[31:], '--', label='NCC', color='darkred', linewidth=1)
    # plt.plot(augmentation_magnitude[31:], uiq[31:], '.-', label='UIQ', color='darkred', linewidth=1)
    # plt.plot(augmentation_magnitude[31:], scc[31:], ':', label='SCC', color='darkred', linewidth=1)
    ...
    # plt.axhline(y=chance_underestimate, color='blue', linestyle=':', label=f'Model lower bound / Chance={chance_underestimate}', linewidth=2, alpha=0.4)
    ...
    # plt.savefig(f"/home/ekagra/Documents/GitHub/MasterArbeit/final_plots/{augmentation_type}_plot.png")
    # plt.show()
    ...
    # plt.plot(augmentation_magnitude, model_accuracy, "-", label="Model Confidence", color="blue", linewidth=2)
    # plt.plot(augmentation_magnitude, estimated_confidence_values1, '-.', label=f'k={k1_neg, k1_pos}', color='purple', linewidth=2)
    # plt.plot(augmentation_magnitude, estimated_confidence_values2, '-.', label=f'k={k2_neg, k2_pos}', color='purple', linewidth=2)
    # plt.plot(augmentation_magnitude, ssim, '-', label='SSIM', color='darkred', linewidth=1)
    # plt.plot(augmentation_magnitude, ncc, '--', label='NCC', color='darkred', linewidth=1)
    # plt.plot(augmentation_magnitude, uiq, '.-', label='UIQ', color='darkred', linewidth=1)
    # plt.plot(augmentation_magnitude, scc, ':', label='SCC', color='darkred', linewidth=1)
    # plt.axhline(y=chance_overestimate, color='red', linestyle=':', label=f'HVS lower bound / Chance={chance_overestimate}', linewidth=2, alpha=0.4)
    # plt.axhline(y=chance_underestimate, color='blue', linestyle=':', label=f'Model lower bound / Chance={chance_underestimate}', linewidth=2, alpha=0.4)
    # plt.yticks(list(plt.yticks()[0]) + [chance_overestimate])
    # plt.gca().get_yticklabels()[-1].set_color('red')
    ...
    # plt.legend()
    # plt.tight_layout()
    # plt.savefig(f"/home/ekagra/Documents/GitHub/MasterArbeit/final_plots/{augmentation_type}_wo_hvs_plot.png")
    # plt.show()
    ...
    # estimated_confidence_values1 = 1 - (1 - chance_overestimate) * (abs(augmentation_magnitude)) ** k1
    # estimated_confidence_values2 = 1 - (1 - chance_overestimate) * (abs(augmentation_magnitude)) ** k2
    # estimated_confidence_values1 = np.clip(estimated_confidence_values1, chance_overestimate, 1.0)
    # estimated_confidence_values2 = np.clip(estimated_confidence_values2, chance_overestimate, 1.0)
    # estimated_confidence_values1_m = 1 - (1 - chance_underestimate) * (abs(augmentation_magnitude)) ** k1
    # estimated_confidence_values2_m = 1 - (1 - chance_underestimate) * (abs(augmentation_magnitude)) ** k2
    # estimated_confidence_values1_m = np.clip(estimated_confidence_values1_m, chance_underestimate, 1.0)
    # estimated_confidence_values2_m = np.clip(estimated_confidence_values2_m, chance_underestimate, 1.0)
    ...
    # ssim, ncc, uiq, scc = plot_severity_vs_confidence(augmentation_type)
    # plt.figure(figsize=(10, 6))
    # plt.plot(rotation_values_lim[31:] / 135., confidence_values_lim[31:], '-', label=f'Contrast HVS', color='red', linewidth=2)
    # plt.plot(augmentation_magnitude[31:], model_accuracy[31:], "-", label="Model Confidence", color="blue", linewidth=2)
    # plt.plot(augmentation_magnitude[31:], estimated_confidence_values1[31:], '-.', label=f'k={k1}', color='purple', linewidth=2)
    # plt.plot(augmentation_magnitude[31:], estimated_confidence_values2_m[31:], '--', label=f'k={k2}', color='purple', linewidth=2)
    # plt.plot(augmentation_magnitude[31:], ssim[31:], '-', label='SSIM', color='darkred', linewidth=1)
