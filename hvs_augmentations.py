...
if __name__ == "__main__":
    ...
    # plt.plot(rotation_values_lim, confidence_values_lim, marker="o", label=f"Rotation HVS", color="red")
    # plt.plot(augmentation_magnitude, estimated_confidence_values1, marker='o', label=f'k={k1}', color='blue')
    # plt.plot(augmentation_magnitude, estimated_confidence_values2, marker='o', label=f'k={k2}', color='green')
    # plt.plot(augmentation_magnitude, estimated_confidence_values3, marker='o', label=f'k={k3}', color='purple')
    # # plt.plot(augmentation_magnitude, model_accuracy, "--", label="Model Confidence", color="black")
    # plt.xlabel(f"{augmentation_type}")
    # plt.ylabel("Confidence")
    # plt.title(f"HVS for {augmentation_type}")
    ...
    # augmentation_magnitude, augmentation_mean, model_accuracy = model_confidence(augmentation_type='Contrast')
    ...
    plt.figure(figsize=(10, 6))
    plt.plot(rotation_values_lim / 135., confidence_values_lim, marker="o", label=f"Rotation HVS", color="red")
    plt.plot(augmentation_magnitude, estimated_confidence_values1, marker='o', label=f'k={k1}', color='blue')
    plt.plot(augmentation_magnitude, estimated_confidence_values2, marker='o', label=f'k={k2}', color='green')
    plt.plot(augmentation_magnitude, estimated_confidence_values3, marker='o', label=f'k={k3}', color='purple')
    # plt.plot(augmentation_magnitude, model_accuracy, "--", label="Model Confidence", color="black")
    ...
    visibility_values_lim_all = 2 * visibility_values_lim - 1
    confidence_values_lim = np.interp(visibility_values_lim, visibility_values1, confidence_values)
    confidence_values_lim = confidence_values_lim[::-1]
    chance = min(confidence_values_lim)
    print(f'{augmentation_type} chance: {chance}')
    ...
    plt.figure(figsize=(10, 6))
    plt.plot(visibility_values_lim, confidence_values_lim, '--', label=f'Occlussion HVS', color='black')
