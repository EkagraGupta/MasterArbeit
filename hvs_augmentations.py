...
if __name__ == "__main__":
    ...
    # estimated_confidence_values1_neg = 1 - (1 - chance) * (augmentation_magnitude_neg) ** k1_neg
    # estimated_confidence_values2_neg = 1 - (1 - chance) * (augmentation_magnitude_neg) ** k2_neg
    # estimated_confidence_values3_neg = 1 - (1 - chance) * (augmentation_magnitude_neg) ** k3_neg
    # estimated_confidence_values4_neg = 1 - (1 - chance) * (augmentation_magnitude_neg) ** k4_neg
    ...
    # estimated_confidence_values3_pos = 1 - (1 - np.array(model_accuracy)[-1]) * (augmentation_magnitude_pos) ** k3_pos
    # estimated_confidence_values4_pos = 1 - (1 - np.array(model_accuracy)[-1]) * (augmentation_magnitude_pos) ** k4_pos
    ...
    # estimated_confidence_values3 = np.hstack((np.array(estimated_confidence_values3_neg), np.array(estimated_confidence_values3_pos)))
    # estimated_confidence_values4 = np.hstack((np.array(estimated_confidence_values4_neg), np.array(estimated_confidence_values4_pos)))
    # estimated_confidence_values1 = np.clip(estimated_confidence_values1, chance, 1.0)
    # estimated_confidence_values2 = np.clip(estimated_confidence_values2, chance, 1.0)
    # estimated_confidence_values3 = np.clip(estimated_confidence_values3, chance, 1.0)
    # estimated_confidence_values4 = np.clip(estimated_confidence_values4, chance, 1.0)
    ...
    # plt.plot(augmentation_magnitude, model_accuracy, "--", label="Model Confidence", color="black")
    # plt.plot(augmentation_magnitude, estimated_confidence_values1, '-', label=f'k={k1_neg, k1_pos}', color='blue')
    # plt.plot(augmentation_magnitude, estimated_confidence_values2, '-', label=f'k={k2_neg, k2_pos}', color='green')
    # plt.plot(augmentation_magnitude, estimated_confidence_values3, '-', label=f'k={k3_neg, k3_pos}', color='purple')
    # plt.plot(augmentation_magnitude, estimated_confidence_values4, '-', label=f'k={k4_neg, k4_pos}', color='orange')
    # plt.axhline(y=chance, color='magenta', linestyle=':', label=f'HVS lower bound / Chance={chance}')
    # plt.axhline(y=min(model_accuracy), color='black', linestyle=':', label=f'Model lower bound={min(model_accuracy)}')
    # plt.xlabel(f"Magnitude of {augmentation_type}")
    # plt.ylabel("Confidence")
