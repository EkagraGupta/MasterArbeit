...
if __name__ == "__main__":
    ...
    ax[2, 0].plot(augmentation_magnitude_single, const_k, '-', label=f'k={2}, Confidence$\geq${0.5}', color=constk_color, linewidth=2)
    ...
    ax[2, 0].set_xlabel(f"Magnitude of Augmentation", fontsize=12, fontweight='bold')
    ax[2, 0].set_ylabel("Confidence", fontsize=12, fontweight='bold')
    ...
    ax[0, 1].plot(augmentation_magnitude, const_k, '-', label=f'k={2}, Confidence$\geq${0.5}', color=constk_color, linewidth=2)
    ...
    # ax[0, 1].set_ylabel("Confidence", fontsize=12, fontweight='bold')
    ...
    ax[0, 0].plot(augmentation_magnitude, const_k, '-', label=f'k={2}, Confidence$\geq${0.5}', color=constk_color, linewidth=2)
    ...
    ax[0, 0].set_ylabel("Confidence", fontsize=12, fontweight='bold')
    ...
    ax[0, 3].plot(augmentation_magnitude, const_k, '-', label=f'k={2}, Confidence$\geq${chance_constant_k}', color=constk_color, linewidth=2)
    ...
    # ax[0, 3].set_ylabel("Confidence", fontsize=12, fontweight='bold')
    ...
    ax[0, 2].plot(augmentation_magnitude, const_k, '-', label=f'k={2}, Confidence$\geq${chance_constant_k}', color=constk_color, linewidth=2)
    ...
    # ax[0, 2].set_ylabel("Confidence", fontsize=12, fontweight='bold')
    ...
    ax[1, 0].plot(augmentation_magnitude_single, const_k, '-', label=f'k={2}, Confidence$\geq${chance_constant_k}', color=constk_color, linewidth=2)
    ...
    ax[1, 0].set_ylabel("Confidence", fontsize=12, fontweight='bold')
    ...
    ax[1, 1].plot(augmentation_magnitude_single, const_k, '-', label=f'k={2}, Confidence$\geq${chance_constant_k}', color=constk_color, linewidth=2)
    ...
    # ax[1, 1].set_ylabel("Confidence", fontsize=12, fontweight='bold')
    ...
    ax[1, 2].plot(augmentation_magnitude_single, const_k, '-', label=f'k={2}, Confidence$\geq${chance_constant_k}', color=constk_color, linewidth=2)
    ...
    # ax[1, 2].set_ylabel("Confidence", fontsize=12, fontweight='bold')
    ...
    ax[1, 3].plot(augmentation_magnitude_single, const_k, '-', label=f'k={2}, Confidence$\geq${chance_constant_k}', color=constk_color, linewidth=2)
    ...
    ax[1, 3].set_xlabel(f"Magnitude of Augmentation", fontsize=12, fontweight='bold')
    # ax[1, 3].set_ylabel("Confidence", fontsize=12, fontweight='bold')
    ...
    ax[2, 1].plot(augmentation_magnitude, const_k, '-', label=f'k={2}, Confidence$\geq${chance_constant_k}', color=constk_color, linewidth=2)
    ...
    ax[2, 1].set_xlabel(f"Magnitude of Augmentation", fontsize=12, fontweight='bold')
    # ax[2, 1].set_ylabel("Confidence", fontsize=12, fontweight='bold')
    ...
    ax[2, 2].plot(const_severity, const_k, '-', label=f'k={2}, Confidence$\geq${chance_constant_k}', color=constk_color, linewidth=2)
    ...
    ax[2, 2].set_xlabel(f"Magnitude of Augmentation", fontsize=12, fontweight='bold')
    # ax[2, 2].set_ylabel("Confidence", fontsize=12, fontweight='bold')
    ...
    ('k=2, Confidence$\geq$0.5', constk_color, '-'),
    ...
    file_name = "final_plots/all_augmentations_subpot.pdf"
