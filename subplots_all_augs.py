...
if __name__ == "__main__":
    ...
    ax[2, 0].set_ylabel("Label Confidence", fontsize=8)
    ...
    # ax[0, 1].set_ylabel("Label Confidence", fontsize=8)
    ...
    ax[0, 0].set_ylabel("Label Confidence", fontsize=8)
    ...
    # ax[0, 3].set_ylabel("Label Confidence", fontsize=8)
    ...
    # ax[0, 2].set_ylabel("Label Confidence", fontsize=8)
    ...
    ax[1, 0].set_ylabel("Label Confidence", fontsize=8)
    ...
    # ax[1, 1].set_ylabel("Label Confidence", fontsize=8)
    ...
    # ax[1, 2].set_ylabel("Label Confidence", fontsize=8)
    ...
    # ax[1, 3].set_ylabel("Label Confidence", fontsize=8)
    ...
    # ax[2, 1].set_ylabel("Label Confidence", fontsize=8)
    ...
    # ax[2, 2].set_ylabel("Label Confidence", fontsize=8)
